...
const News = () => {
  ...
  return (
    <section className="lg:px-2 py-4 mt-4">
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] md:text-base">
        {/* Heading and Subtitle */}
        <div className="">
          <h5 className="text-primary text-xl md:text-2xl font-semibold flex justify-start items-center gap-2">
            Latest News
          </h5>
          <p className="text-[10px] md:text-sm text-neutral-500 my-2">
