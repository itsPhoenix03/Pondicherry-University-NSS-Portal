  ...
  if (_id)
    return (
      <div className="relative p-[1px] cursor-default group">
        <div className="absolute bg-accent/50 top-0 left-0 w-full h-full skew-y-3 lg:skew-y-0 -z-[0] lg:group-hover:skew-y-3 transition-all duration-500 ease-in-out" />
        ...
        <div className="relative p-4 col-span-1 flex flex-col justify-center items-start gap-6 bg-white min-h-[18rem]">
          ...
          <div className="flex justify-between items-center gap-6 w-full">
            <h6 className="font-semibold text-sm lg:text-xl underline underline-offset-8">
              {event_name}
            </h6>
            ...
            <div className="w-full flex flex-wrap justify-start items-center gap-2">
              {tags.map((tag) => (
                <span
                  ...
                  className="bg-primary/10 border border-primary px-2 lg:px-4 py-1 rounded-full text-primary text-[9px] lg:text-xs"
                >
                  {tag}
                </span>
              ))}
          ...
          <p className="font-light text-[10px] lg:text-xs">{description}</p>

          {/* Location and Timing section */}
          <div className="flex flex-col justify-start items-start gap-2">
            <p className="font-semibold text-[9px] lg:text-xs">
